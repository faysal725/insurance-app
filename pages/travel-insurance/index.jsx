...
function MotorInsurancePage() {
  ...
  return (
    <HomePageLayout pageTitle={"Travel Insurance"}>
      ...
      <Modal open={modalOpen} >
        <div className="modal-box">
          ...
          <div className="modal-body">
            ...
            <h5>
              <span>Application Type</span><span>New</span>
            </h5>
            <h5>
              <span>Vehicle Category</span><span>Private Vehicle</span>
            </h5>
            <h5>
              <span>Plan Type</span><span>Comprehensive</span>
            </h5>
            <h5>
              <span>Vehicle Type</span><span>Private Car</span>
            </h5>
